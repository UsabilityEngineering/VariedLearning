...
- Lola has been given her first assignment in her introduction to scripting class and has never written a script before. The assignment is due in a few days and she would like to complete it ahead of time and quickly while also learning the material. If possible, she would also like to get a handle on basic commands so that she is prepared for future classes and to make the coming assignments easier for her. Lola especially enjoys watching videos about the content she is learning because she likes to listen to the explanations while seeing the material in front of her. She would also like a comprehensive list of beginner comands that she can work on memorizing in addition to the videos. She is excited to practice the commands that she learns but isn't sure where to start or what type of project she should work on.

- Charlie has been working in tech for the past few years. He uses scripts in his daily work to speed up his workflow, although he finds himself having to complete some repetitive tasks. When Charlie doesn't know how to do something, his first instict is to look up his problem online. Sometimes the results he gets are broad or not specific enough to answer his particular question, so he sometimes asks coworkers for help with questions. A lot of the time, Charlie finds that only the more basic questions regarding bash and scripting are answered in depth online, and more compelx and advanced material is rarely asked about in the same amount of detail. If possible, Charlie would like to be able to find answers to his more advanced scripting questions online and not have to bother his coworkers. 

- Enzo is working towards his Master's Degree in Computer Science. He is a full time student and is passionate about his degree focus. Enzo loves automating tasks and is excited to one day work in a field where he can help automate processes. He is knowledgable when it comes to bash and scripting although his tough classes often challenge him which he doesn't mind since he loves to learn more. Outside of class, Enzo wants to begin working on a project related to his work for his own interest as well as to put on  his resume and to mention in interviews in the future. He would like to learn as much as possible and become a master scripter, but a lot of online content is aimed at beginners or basic commands. Enzo wants to learn to write complex scripts that will prepare him to create a successful and impressive personal project.  
